...
const data = [
  ...
  { id: 6, node_code: "pay_experiment_fee", node_name: "试验费付款" },
  { id: 7, node_code: "assign_task", node_name: "下达任务" },
  { id: 8, node_code: "estimate_completion", node_name: "预计完成" },
  { id: 9, node_code: "experiment_check", node_name: "试验检测" },
