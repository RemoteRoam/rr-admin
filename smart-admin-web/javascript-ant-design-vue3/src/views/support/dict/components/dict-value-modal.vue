    ...
    <a-card size="small" :bordered="false">
      <a-row class="smart-table-btn-block">
        <div class="smart-table-operate-block">
          ...
          <a-button @click="confirmBatchDelete" type="text" danger size="small"
      ...
      <a-table size="small" :dataSource="tableData" :columns="columns" rowKey="dictValueId" :pagination="false"
        :row-selection="{ selectedRowKeys: selectedRowKeyList, onChange: onSelectChange }" bordered>
