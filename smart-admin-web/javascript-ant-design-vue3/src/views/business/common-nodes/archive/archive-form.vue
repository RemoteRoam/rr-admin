            ...
            <a-row>
                <a-col :span="24">
                    <a-form-item label="归档位置" name="archivePosition">
                        <a-input style="width: 95%" v-model:value="form.archivePosition" placeholder="归档位置" />
                    </a-form-item>
                </a-col>
            </a-row>
            <a-row>
                <a-col :span="24">
                    <a-form-item label="归档日期" name="archiveDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.archiveDate" style="width: 95%"
                            placeholder="归档日期" />
                    </a-form-item>
                </a-col>
            </a-row>
...
const formDefault = {
    ...
    nodeId: NODE_CONST.archive, //节点ID
