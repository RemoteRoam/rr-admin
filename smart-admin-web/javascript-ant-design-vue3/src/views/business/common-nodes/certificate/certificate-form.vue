...
-->
<template>
    <a-modal title="证书" width="600px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 7 }">
            <a-row>
                <a-col :span="24">
                    <a-form-item label="证书编号" name="certificateNo">
                        <a-input style="width: 95%" v-model:value="form.certificateNo" placeholder="证书编号" />
                    </a-form-item>
                </a-col>
            </a-row>
            <a-row>
