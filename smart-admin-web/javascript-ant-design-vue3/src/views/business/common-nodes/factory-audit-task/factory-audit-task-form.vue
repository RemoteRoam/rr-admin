...
-->
<template>
    <a-modal title="工厂审核任务" width="600px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 6 }">
            ...
            <a-row>
                <a-col :span="24">
                    <a-form-item label="审核任务日期" name="auditTaskDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.auditTaskDate" style="width: 100%"
                            placeholder="审核任务日期" />
                    </a-form-item>
                </a-col>
            </a-row>
...
const formDefault = {
    ...
    nodeId: NODE_CONST.factory_audit_task, //节点ID
    nodeStatus: 0, //节点状态
