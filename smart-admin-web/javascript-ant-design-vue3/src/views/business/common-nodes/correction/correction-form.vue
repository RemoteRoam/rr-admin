...
-->
<template>
    <a-modal title="不符合项整改" width="400px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }">
            <a-row>
                <a-col :span="24">
                    <a-form-item label="整改内容" name="rectificationContent">
                        <a-textarea v-model:value="form.rectificationContent" placeholder="整改内容" />
                    </a-form-item>
                </a-col>
            </a-row>
            <a-row>
                <a-col :span="24">
                    <a-form-item label="整改日期" name="rectificationDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.rectificationDate"
                            style="width: 100%" placeholder="整改日期" />
                    </a-form-item>
                </a-col>
            </a-row>
...
const formDefault = {
    ...
    nodeId: NODE_CONST.non_conformity_correction, //节点ID
    nodeStatus: 0, //节点状态
    passReason: undefined, //跳过原因
    rectificationContent: undefined, //整改内容
    rectificationDate: undefined, //整改时间
};
