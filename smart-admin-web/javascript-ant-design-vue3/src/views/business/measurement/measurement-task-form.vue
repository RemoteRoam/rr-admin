    ...
    >
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }" >
            <a-row>
                    ...
                    <a-form-item label="实验室任务编号"  name="taskdNo">
                        <a-input style="width: 100%" v-model:value="form.taskdNo" placeholder="实验室任务编号" />
                    </a-form-item>
                    <a-form-item label="项目ID"  name="projectId">
                        <a-input-number style="width: 100%" v-model:value="form.projectId" placeholder="项目ID" />
                    </a-form-item>
                    <a-form-item label="三方机构ID（实验室ID）"  name="thirdPartyId">
                        <a-input-number style="width: 100%" v-model:value="form.thirdPartyId" placeholder="三方机构ID（实验室ID）" />
                    </a-form-item>
                    ...
                    <a-form-item label="有效期"  name="expiryDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.expiryDate" style="width: 100%" placeholder="有效期"/>
                    </a-form-item>
                    ...
                    <a-form-item label="计量日期"  name="measurementDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.measurementDate" style="width: 100%" placeholder="计量日期"/>
                    </a-form-item>
                    <a-form-item label="完成日期"  name="finishDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.finishDate" style="width: 100%" placeholder="完成日期"/>
                    </a-form-item>
                    <a-form-item label="状态（ProjectStatusEnum）"  name="status">
                        <a-input-number style="width: 100%" v-model:value="form.status" placeholder="状态（ProjectStatusEnum）" />
                    </a-form-item>
                    <a-form-item label="操作人"  name="operateUserId">
                        <a-input-number style="width: 100%" v-model:value="form.operateUserId" placeholder="操作人" />
                    </a-form-item>
                    <a-form-item label="操作人姓名"  name="operateUserName">
                        <a-input style="width: 100%" v-model:value="form.operateUserName" placeholder="操作人姓名" />
                    </a-form-item>
                    <a-form-item label="操作时间"  name="operateTime">
                        <a-date-picker show-time valueFormat="YYYY-MM-DD HH:mm:ss" v-model:value="form.operateTime" style="width: 100%" placeholder="操作时间" />
                    </a-form-item>
...
<script setup>
    ...
    const rules = {
        ...
        taskdNo: [{ required: true, message: '实验室任务编号 必填' }],
    };
