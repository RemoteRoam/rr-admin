            ...
            <a-row>
                <a-col :span="8">
                    <a-form-item label="负责人" name="managerId">
                        <EmployeeSelect width="100%" v-model:value="form.managerId" placeholder="" />
                    </a-form-item>
            ...
            <a-row>
                <a-col :span="8">
                    <a-form-item label="邮寄日期" name="mailingDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.mailingDate" style="width: 100%"
                            placeholder="邮寄日期" />
                    </a-form-item>
                </a-col>
                <a-col :span="8">
...
async function detail(id) {
    try {
        let result = await measurementApi.detail(id);
