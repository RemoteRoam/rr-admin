    ...
    >
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }" >
            <a-row>
                    ...
                    <a-form-item label="负责人ID"  name="managerId">
                        <a-input-number style="width: 100%" v-model:value="form.managerId" placeholder="负责人ID" />
                    </a-form-item>
                    ...
                    <a-form-item label="收款日期"  name="paymentDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.paymentDate" style="width: 100%" placeholder="收款日期"/>
                    </a-form-item>
                    <a-form-item label="备注"  name="remark">
                        <a-input style="width: 100%" v-model:value="form.remark" placeholder="备注" />
                    </a-form-item>
                    <a-form-item label="开票日期"  name="invoiceDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.invoiceDate" style="width: 100%" placeholder="开票日期"/>
                    </a-form-item>
