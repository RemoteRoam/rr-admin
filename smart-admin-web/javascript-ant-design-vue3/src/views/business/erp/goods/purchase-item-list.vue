...
<template>
    ...
    <a-form class="smart-query-form">
        <a-row class="smart-query-form-row">
            <a-form-item label="采购入库单ID" class="smart-query-form-item">
                <a-input style="width: 150px" v-model:value="queryForm.purchaseId" placeholder="采购入库单ID" />
            </a-form-item>
    ...
    <a-card size="small" :bordered="false" :hoverable="true">
        ...
        <PurchaseItemForm ref="formRef" @reloadList="queryData" />
...
import PurchaseItemForm from './purchase-item-form.vue';
// ---------------------------- 表格列 ----------------------------
...
async function queryData() {
    ...
    try {
        let queryResult = await purchaseItemApi.queryPage(queryForm);
...
async function requestDelete(data) {
    ...
    try {
        ...
        await purchaseItemApi.delete(data.id);
