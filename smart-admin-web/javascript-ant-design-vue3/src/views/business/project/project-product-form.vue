    ...
    <a-modal :title="form.id ? '编辑' : '添加'" width="500px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        ...
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }">
            <a-row>
                ...
                <a-form-item label="实验室任务ID" name="taskId">
                    <a-input-number style="width: 100%" v-model:value="form.taskId" placeholder="实验室任务ID" />
                </a-form-item>
                ...
                <a-form-item label="自我声明日期" name="selfDeclarationDate">
                    <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.selfDeclarationDate" style="width: 100%"
                        placeholder="自我声明日期" />
                </a-form-item>
                ...
                <a-form-item label="证书发送日期" name="certificateSendDate">
                    <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.certificateSendDate" style="width: 100%"
                        placeholder="证书发送日期" />
                </a-form-item>
                <a-form-item label="证书有效期截止日期" name="certificateExpiryDate">
                    <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.certificateExpiryDate"
                        style="width: 100%" placeholder="证书有效期截止日期" />
                </a-form-item>
                <a-form-item label="项目认证费表ID" name="certificationFeeId">
                    <a-input-number style="width: 100%" v-model:value="form.certificationFeeId"
                        placeholder="项目认证费表ID" />
                </a-form-item>
                <a-form-item label="项目归档表ID" name="archiveId">
                    <a-input-number style="width: 100%" v-model:value="form.archiveId" placeholder="项目归档表ID" />
                </a-form-item>
                <a-form-item label="项目邮寄表ID" name="mail">
                    <a-input-number style="width: 100%" v-model:value="form.mail" placeholder="项目邮寄表ID" />
                </a-form-item>
...
const formDefault = {
    ...
    certificationFeeId: undefined, //项目认证费表ID
    archiveId: undefined, //项目归档表ID
    mail: undefined, //项目邮寄表ID
