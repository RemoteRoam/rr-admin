    ...
    <a-form class="smart-query-form">
        <a-row class="smart-query-form-row">
            ...
            <a-form-item label="项目类型" class="smart-query-form-item">
                <SmartEnumSelect width="150px" v-model:value="queryForm.projectType" enumName="PROJECT_TYPE_SYSTEM_ENUM" placeholder="项目类型"/>
            </a-form-item>
            ...
            <a-form-item label="来源分类" class="smart-query-form-item">
                <SmartEnumSelect width="150px" v-model:value="queryForm.sourceType" enumName="SOURCE_TYPE_ENUM" placeholder="来源分类"/>
            </a-form-item>
            <a-form-item label="来源" class="smart-query-form-item">
                <ThirdPartySelect width="150px" v-model:value="queryForm.sourceId" placeholder="请选择咨询机构" type="THIRD_3"/>
            </a-form-item>
            <a-form-item label="认证机构" class="smart-query-form-item">
                <ThirdPartySelect width="150px" v-model:value="queryForm.thirdPartyId" placeholder="请选择认证机构" type="THIRD_2"/>
            </a-form-item>
            ...
            <a-form-item label="合同日" class="smart-query-form-item">
                <a-range-picker v-model:value="queryForm.contractDate" :presets="defaultTimeRanges" style="width: 250px" @change="onChangeContractDate" />
            </a-form-item>
            <a-form-item label="客户预期日期" class="smart-query-form-item">
                <a-range-picker v-model:value="queryForm.expectedDate" :presets="defaultTimeRanges" style="width: 250px" @change="onChangeExpectedDate" />
            </a-form-item>
