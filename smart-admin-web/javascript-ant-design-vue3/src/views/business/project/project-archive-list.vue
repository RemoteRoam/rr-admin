...
<template>
    ...
    <a-card size="small" :bordered="false" :hoverable="true">
        ...
        <ProjectArchiveForm  ref="formRef" @reloadList="queryData"/>
...
<script setup>
    ...
    import ProjectArchiveForm from './project-archive-form.vue';
    // ---------------------------- 表格列 ----------------------------
    ...
    async function queryData() {
        ...
        try {
            let queryResult = await projectArchiveApi.queryPage(queryForm);
