    ...
    >
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }" >
            <a-row>
                    ...
                    <a-form-item label="付款方(客户/我方)"  name="payParty">
                        <a-input-number style="width: 100%" v-model:value="form.payParty" placeholder="付款方(客户/我方)" />
                    </a-form-item>
                    <a-form-item label="认证费付款日期"  name="payDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.payDate" style="width: 100%" placeholder="认证费付款日期"/>
                    </a-form-item>
