...
-->
<template>
    <a-modal title="前期资料传递" width="600px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
                ...
                <a-col :span="24">
                    <a-form-item label="前期资料传递日期" name="preDataTransferDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.preDataTransferDate"
                            style="width: 100%" placeholder="前期资料传递日期" />
                    </a-form-item>
                </a-col>
            </a-row>
...
const formDefault = {
    ...
    nodeId: NODE_CONST.pre_data_transfer, //节点ID
