...
-->
<template>
    <a-modal title="整改日期" width="600px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
...
const formDefault = {
    ...
    nodeId: NODE_CONST.rectification_date, //节点ID
    nodeStatus: undefined, //节点状态
    passReason: undefined, //跳过原因
    rectificationDate: undefined, //资料上报日期
};
