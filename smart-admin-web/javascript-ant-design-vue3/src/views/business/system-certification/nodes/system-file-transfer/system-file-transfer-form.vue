...
-->
<template>
    <a-modal title="体系文件传递" width="600px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
                ...
                <a-col :span="24">
                    <a-form-item label="体系文件传递日期" name="systemFileTransferDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.systemFileTransferDate"
                            style="width: 100%" placeholder="体系文件传递日期" />
                    </a-form-item>
                </a-col>
            </a-row>
...
const formDefault = {
    ...
    nodeId: NODE_CONST.system_file_transfer, //节点ID
