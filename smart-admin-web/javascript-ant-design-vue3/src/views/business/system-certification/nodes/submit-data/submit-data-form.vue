...
-->
<template>
    <a-modal title="资料上报" width="600px" :open="visibleFlag" @cancel="onClose" :maskClosable="false"
        :destroyOnClose="true">
        <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 6 }">
            <a-row>
                <a-col :span="24">
                    <a-form-item label="上报日期" name="dataReportDate">
                        <a-date-picker valueFormat="YYYY-MM-DD" v-model:value="form.dataReportDate" style="width: 100%"
                            placeholder="资料上报日期" />
                    </a-form-item>
                </a-col>
            </a-row>
