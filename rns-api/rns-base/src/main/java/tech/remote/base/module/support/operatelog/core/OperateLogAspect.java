...
import tech.remote.base.module.support.operatelog.OperateLogDao;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(tech.remote.base.module.support.operatelog.annotation.OperateLog) || @annotation(tech.remote.base.module.support.operatelog.annotation.OperateLog)";
